  ...
  return (
    <Layout titulo="Control de avance individual del alumno">
      ...
      {cargando ? (
        ...
        <ChecklistE1 progreso={progresoE1} editable onCambiar={cambiarE1} />
      ) : pestana === 'e3' ? (
        ...
        <TablaConceptosNucleo conceptos={progresoE4} editable onCambiar={cambiarNucleo('progresoE4', setProgresoE4)} />
      )}
    </Layout>
  )
}
